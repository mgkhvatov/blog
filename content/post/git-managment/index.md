...
summary: 'Здесь я попробую рассказать о системе контрол версий Git'
...
![Local version control](local.jpg)
...
![Centralized version control](centralized.jpg)
...
![Distributed version control](distributed.jpg)
